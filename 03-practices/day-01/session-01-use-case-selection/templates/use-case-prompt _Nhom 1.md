...
---
Mục tiêu: giúp PM, subPM có thể kiểm soát tiến độ dự án nhanh chóng và chính xác thông qua việc hỏi AI về tiến độ và các chỉ số của dự án.
...
Đầu vào mô phỏng:
    ...
    Tin nhắn do nhân sự phụ trách cung cấp.

Đầu ra mong muốn:

    Tiến độ luỹ kế theo từng nhân sự phụ trách.
    Nguồn trích dẫn từ tài liệu giả lập.
    Khuyến nghị liên hệ nhân sự nếu câu hỏi vượt phạm vi.

Rủi ro chính: trả lời sai tiến độ, số liệu hoặc suy đoán khi thiếu căn cứ.
---
